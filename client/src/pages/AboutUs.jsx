...
const AboutUs = () => {
	return (
		<div className="flex justify-center w-screen">
			<div className="min-h-screen bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-200 pt-5 px-4 sm:px-16 w-screen justify-center items-center mt-16">
		...
		// <div className="min-h-screen bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-200 pt-5 px-4 sm:px-8 max-w-5xl justify-center items-center mt-16">
		//   <h1 className="text-3xl sm:text-4xl font-bold mb-6 text-center">
		//     About Zestara
		//   </h1>
		//   <p className="text-lg mb-4">
